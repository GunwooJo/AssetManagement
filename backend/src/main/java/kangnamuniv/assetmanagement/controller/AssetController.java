...
public class AssetController {
    ...
    @PostMapping("/asset")
    public ResponseEntity<ResponseDTO> createAsset(@RequestHeader(value = "Authorization") String token) {
    ...
    @GetMapping("/asset")
    public ResponseEntity<ResponseDTO> getAsset(@RequestHeader(value = "Authorization") String token,
        ...
        try {
            List<AssetDTO> foundAssets = assetService.findAssetsByMemberAndDates(foundMember, startDate, endDate);
            return ResponseEntity.ok(new ResponseDTO("성공", foundAssets, null));
